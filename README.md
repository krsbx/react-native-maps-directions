...
[![npm Version](https://img.shields.io/npm/v/rn-maps-directions.svg?style=flat)](https://www.npmjs.com/package/rn-maps-directions)
[![npm Downloads](https://img.shields.io/npm/dm/rn-maps-directions.svg)](https://www.npmtrends.com/rn-maps-directions)
[![Contributors](https://img.shields.io/github/contributors/bramus/rn-maps-directions.svg)](https://github.com/krsbx/rn-maps-directions/graphs/contributors)
[![GitHub Last Commit](https://img.shields.io/github/last-commit/krsbx/rn-maps-directions.svg)](https://github.com/krsbx/rn-maps-directions)
[![License](https://img.shields.io/npm/l/rn-maps-directions.svg)](LICENSE.md)
...
![rn-maps-directions](https://user-images.githubusercontent.com/213073/33188062-efc86e24-d096-11e7-87eb-6925291bc809.png)

## Installation

Install `rn-maps-directions` as a dependency using either

- [Node's `npm`](https://nodejs.org/en/download/)

  ```
  npm install rn-maps-directions
  ```

- [Yarn](https://yarnpkg.com/en/docs/install)

  ```
  yarn add rn-maps-directions
  ```
...
```js
import MapViewDirections from 'rn-maps-directions';
...
An example app can be found in a separate repo, located at [https://github.com/bramus/rn-maps-directions-example](https://github.com/bramus/rn-maps-directions-example).
